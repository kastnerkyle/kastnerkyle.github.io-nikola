...
BLOG_AUTHOR = "Kyle Kastner"  # (translatable)
BLOG_TITLE = "Garbage In Garbage Out"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "https://kastnerkyle.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://kastnerkyle.github.io/"
BLOG_EMAIL = "kastnerkyle+blogsite@gmail.com"
BLOG_DESCRIPTION = "A blog about many things"  # (translatable)
    ...
    DEFAULT_LANG: (
        ...
        (
            (
                ...
                ('http://mlwave.com/', "MLWave"),
                ('http://snippyhollow.github.io/', "SnippyHollow"),
